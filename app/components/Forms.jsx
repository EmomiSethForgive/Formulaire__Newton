    ...
    <div className="md:w-[50%] w-full">
      <form className=" flex flex-col">
        <div className="flex flex-col  gap-2">
          ...
          <input type="text" placeholder="Nom" className=" border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <input type="text" placeholder="Prénom" className=" border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          ...
          <input type="text" placeholder="Fichier" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          ...
          <input type="text" placeholder="Ville de résisdence" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <input type="text" placeholder="Adresse" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <div className="flex gap-1">
          ...
          <select className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%]">
            <option disabled selected className="bg-transparent">Vous etes?</option>
            <option  className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%]">Bailleurs</option>
            <option  className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%]">Locataire</option>
            <option  className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%]">Agence Immobilière</option>
          </select>
         {/*  <input type="text" placeholder="Vous tees?" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />  */}
          <input type="text" placeholder="Types" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <div className="flex gap-1">
            <input type="calendar" placeholder="Années de construction" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-[49.7%] w-[24.8%] " />
          ...
          <input type="text" placeholder="Nombre de pieces" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <input type="text" placeholder="Location" className="border border-gray-600 bg-transparent  h-10  rounded-md pl-3 max-sm:pl-2 max-sm:w-full w-[%] md:w-[50%] " />
          <button type="submit"className="border border-gray-600 bg-transparent  h-10  rounded-md font-semibold w-[25%]  md:w-[15%] ">Ajouter</button>
        </div>
      </form>
    </div>
